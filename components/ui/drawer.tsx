...
const DrawerOverlay = ({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/80 sm:mx-auto sm:max-w-md',
        className,
      )}
      {...props}
    />
